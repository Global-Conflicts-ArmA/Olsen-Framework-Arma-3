...
_this spawn {
	...
	private _fncTrackArray = {
		private _count = _count + 1;
	...
	switch (side _obs) do {
		case west: {
			...
			["tin_var_fireMissions_west", tin_var_fireMissions_west] call FUNC(publicVariable);
		};
		case east: {
			...
			["tin_var_fireMissions_east", tin_var_fireMissions_east] call FUNC(publicVariable);
		};
		case independent: {
			...
			["tin_var_fireMissions_independent", tin_var_fireMissions_independent] call FUNC(publicVariable);
		};
		case civilian: {
			...
			["tin_var_fireMissions_civilian", tin_var_fireMissions_civilian] call FUNC(publicVariable);
		};
	};
