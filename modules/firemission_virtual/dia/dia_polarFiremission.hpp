...
#include "..\functions\FIREMISV\defs.hpp"
...
class DIA_POLARFIREMISSION {
	...
	class POFM_FIREBUTTON: RscButton
	{
		...
		h = ARTILAYOUTHEIGHT * safezoneH;
		shadow = 0;
		onMouseButtonDown = "[] call FIREMISV_fnc_dia_polarFiremissionFire;";
	};
	class POFM_SELECTEDGUNEDIT: RscListbox
	{
		...
		//
		shadow = 0;
		onLBSelChanged = "(_this select 1) call FIREMISV_fnc_dia_polarFiremissionSetArtillery;";
	};
	...
	class POFM_CANCELBUTTON: RscButton
	{
		...
		h = ARTILAYOUTHEIGHT * safezoneH;
		shadow = 0;
		onMouseButtonDown = "[] call FIREMISV_fnc_dia_polarFiremissionCloseDialog;";
	};
};
