...
private _attachSpecs = nil;

params[
	["_unit", objNull, [objNull]],
	["_animset", "STAND", [""]],
	["_gear", "RANDOM", [""]],
	["_forcedSnapPoint", objNull, [objNull]],
	["_interpolate", false, [true]],
	["_attach", true, [true]]
];
...
["ANIM","AUTOTARGET","FSM","MOVE","TARGET"] apply {_unit disableAI _x};
detach _unit;
...
private _waitTime = 1;
[{
	_this params ["_unit", "_gear", "_noWeapon", "_noBackpack", "_weapon"];
...
*/
}, [_unit, _gear, _noWeapon, _noBackpack, _weapon], _waitTime] call CBA_fnc_waitAndExecute;;
...
[{CBA_missionTime > 0},
	{
	_this params["_unit", "_attachObj", "_attachSpecs", "_azimutFix1", "_attach"];

	private _azimutFix	= _azimutFix1 + (_attachSpecs select 2);	//animation dir fix + snappoint (object) direction fix
	...
	//_group = group _unit;
	private _group = ambientAnimMonitor_group;
...
}, [_unit, _attachObj, _attachSpecs, _azimutFix, _attach]] call CBA_fnc_waitUntilAndExecute;
