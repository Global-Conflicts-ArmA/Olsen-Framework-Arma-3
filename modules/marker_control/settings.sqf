...
// [SIDE, MARKER_NAME, DELETE_AFTER_START] call FUNC(Addlayer)
...
// Example:
// [blufor, "markerBlu", true] call FUNC(Addlayer);
// [[blufor, civilian], "markerBlu2", false] call FUNC(Addlayer);
// [opfor, "markerRed", true] call FUNC(Addlayer);
